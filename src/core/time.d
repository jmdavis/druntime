...
@safe:
    ...
    version(Windows)
    {
        ...
        {
            static assert(0, "The given ClockType is not supported by MonoTimeImpl on this system.");
        }
    }
    else version(OSX)
    {
    ...
    else version(Posix)
    {
        version(linux)
        {
            ...
            else static assert(0, "The given ClockType is not supported by MonoTimeImpl on this system.");
        }
